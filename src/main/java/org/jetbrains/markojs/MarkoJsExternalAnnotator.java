 ...
 */
public class MarkoJsExternalAnnotator extends ExternalAnnotator<PsiFile, List<MarkoJsExternalAnnotator.Issue>> {
	...
	public List<Issue> doAnnotate(final PsiFile file) {
		Collection<? extends PsiElement> funcNameNodes =
			XPath.findAll(MarkoJsLanguage.INSTANCE, file, "/script/function/ID");
		Collection<? extends PsiElement> funcCallNameNodes =
			XPath.findAll(MarkoJsLanguage.INSTANCE, file, "//call_expr/ID");
